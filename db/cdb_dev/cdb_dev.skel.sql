...
CREATE TABLE `cdb_log` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=693 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dt30_daily_data` (
  ...
  `month_date` date NOT NULL default '2000-01-01',
...
CREATE TABLE `nagios_events_merge` (
  ...
  PRIMARY KEY  (`start_time`,`cdb_instance_id`),
  KEY `IDX_end_time` (`end_time`)
) ENGINE=MRG_MyISAM DEFAULT CHARSET=utf8 UNION=(`nagios_events_stan`,`nagios_events_sthc`,`nagios_events_vltx`);
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `rpt_datasets`
--

DROP TABLE IF EXISTS `rpt_datasets`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rpt_datasets` (
  `cdb_dataset_id` int(10) unsigned NOT NULL default '0',
  `cdb_prefix` varchar(20) default NULL,
  `cdb_machine` varchar(100) NOT NULL,
  `cdb_object` varchar(50) NOT NULL,
  `cdb_instance` varchar(250) default NULL,
  `parent_name` varchar(50) default NULL,
  `inst_desc` varchar(250) default NULL,
  `cdb_counter` varchar(50) NOT NULL,
  `counter_type` varchar(45) default NULL,
  `counter_subtype` varchar(45) default NULL,
  KEY `idx_dataset_id` (`cdb_dataset_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `zz_t1`
--

DROP TABLE IF EXISTS `zz_t1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `zz_t1` (
  `id` int(10) unsigned NOT NULL auto_increment,
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=99 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED;
/*!40101 SET character_set_client = @saved_cs_client */;
...
END */;;
/*!50003 SET SESSION SQL_MODE=@OLD_SQL_MODE*/;;
/*!50003 DROP PROCEDURE IF EXISTS `cdb_update_daily_data` */;;
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`%`*/ /*!50003 PROCEDURE `cdb_update_daily_data`(
...
END */;;
/*!50003 SET SESSION SQL_MODE=@OLD_SQL_MODE*/;;
/*!50003 DROP PROCEDURE IF EXISTS `rpt_evt_inst_monthly` */;;
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`%`*/ /*!50003 PROCEDURE `rpt_evt_inst_monthly`(
        p_prefix varchar(10),
        p_machine varchar(250),
        p_instance varchar(250),
        p_year   int,
...
END */;;
/*!50003 SET SESSION SQL_MODE=@OLD_SQL_MODE*/;;
/*!50003 DROP PROCEDURE IF EXISTS `rpt_evt_topn_monthly` */;;
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`%`*/ /*!50003 PROCEDURE `rpt_evt_topn_monthly`(
        p_prefix varchar(10),
        p_year   int,
        p_month  int,
        p_topn   int,
...
END */;;
/*!50003 SET SESSION SQL_MODE=@OLD_SQL_MODE*/;;
/*!50003 DROP PROCEDURE IF EXISTS `rpt_TopN_prf` */;;
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`%`*/ /*!50003 PROCEDURE `rpt_TopN_prf`(
        p_prefix varchar(20),
        p_year   int,
        p_month  int
        )
...
END */;;
/*!50003 SET SESSION SQL_MODE=@OLD_SQL_MODE*/;;
/*!50003 DROP PROCEDURE IF EXISTS `test_event_slots` */;;
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`%`*/ /*!50003 PROCEDURE `test_event_slots`(
        p_sd    date,
        p_ed    date,
        p_type  varchar(20),
        p_grade varchar(20)
...
END */;;
/*!50003 SET SESSION SQL_MODE=@OLD_SQL_MODE*/;;
/*!50003 DROP PROCEDURE IF EXISTS `test_evt_topn_data` */;;
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`%`*/ /*!50003 PROCEDURE `test_evt_topn_data`(
        p_prefix varchar(20),
        p_year  int,
        p_month int,
        p_topn  int,
...
END */;;
/*!50003 SET SESSION SQL_MODE=@OLD_SQL_MODE*/;;
/*!50003 DROP PROCEDURE IF EXISTS `test_evt_topn_list` */;;
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`%`*/ /*!50003 PROCEDURE `test_evt_topn_list`(
        p_prefix varchar(20),
        p_year   int,
        p_month  int,
        p_topn   int,
...
END */;;
/*!50003 SET SESSION SQL_MODE=@OLD_SQL_MODE*/;;
/*!50003 DROP PROCEDURE IF EXISTS `test_instance_slots` */;;
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`%`*/ /*!50003 PROCEDURE `test_instance_slots`()
BEGIN
...
END */;;
/*!50003 SET SESSION SQL_MODE=@OLD_SQL_MODE*/;;
/*!50003 DROP PROCEDURE IF EXISTS `_event_slots_01` */;;
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`%`*/ /*!50003 PROCEDURE `_event_slots_01`(
        p_start_date varchar(20),
        p_end_date   varchar(20),
        p_slot_size  varchar(20),
        p_grade      varchar(20)
...
END */;;
/*!50003 SET SESSION SQL_MODE=@OLD_SQL_MODE*/;;
/*!50003 DROP PROCEDURE IF EXISTS `_evt_topn_monthly` */;;
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`%`*/ /*!50003 PROCEDURE `_evt_topn_monthly`(
        p_prefix varchar(20),
        p_year   int,
        p_month  int,
        p_topn   int,
...
END */;;
/*!50003 SET SESSION SQL_MODE=@OLD_SQL_MODE*/;;
/*!50003 DROP PROCEDURE IF EXISTS `_instance_slots` */;;
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`%`*/ /*!50003 PROCEDURE `_instance_slots`(
        p_start_date varchar(30),
        p_end_date varchar(30),
        p_slot_size varchar(20)
        )
