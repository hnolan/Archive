...
CREATE TABLE `cdb_log` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
...
) ENGINE=InnoDB AUTO_INCREMENT=79 DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=361 DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=1772 DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
SET character_set_client = @saved_cs_client;
...
-- Dump completed on 2009-08-01 18:22:05
-- MySQL dump 10.11
--
-- Host: localhost    Database: cdb_dev
-- ------------------------------------------------------
...
INSERT INTO `m06_datasources` VALUES (1,108,'lancsman','rtg','hourly_data_lahc'),(2,108,'lancsman','rtg2','hourly_data_lahc');
